...
function OUpdateInventory() {
    ...
    const idurl="Owner/owner/inventory/getinventorybyid?inventoryCode="+inventory.inventoryCode;
    const url="Owner/owner/inventory/updateinventory"
...
export default OUpdateInventory